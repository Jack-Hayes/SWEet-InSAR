...
- **Not Using C-band** Especially with the hopeful launch of NISAR in May 2025, using longer wavelength SAR data will increase accuracy.
...
Our project underscores the need to improve sampling methodology in future InSAR snow surveying work. Including a broader range of dry snowpack sites and performing robust spatial autocorrelation analyses will help capture the inherent spatial heterogeneity of snow-covered regions in future studies. Such approaches will not only enhance the calibration of InSAR-derived measurements but also provide a more comprehensive understanding of the uncertainties involved in SWE estimation. Overall, this project serves as a first step in exploring the trade-offs and potential of C‑band InSAR for snow hydrology, offering a clear direction for future improvements and research endeavors.
